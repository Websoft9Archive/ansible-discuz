...
<form method="post">
  ...
  <div class="FormGroup">
    ...
    <div class="FormField">
      ...
      <input name="mysqlDatabase" value="discuz">
    </div>

    <div class="FormField">
      <label>MySQL 用户名</label>
      <input name="mysqlUsername" value="discuz" value="discuz">
    </div>

    <div class="FormField">
      <label>MySQL 密码</label>
      <input type="password" name="mysqlPassword" value="{{discuz_db_password}}">
    </div>

    <div class="FormField">
      <label>表前缀</label>
      <input type="text" name="tablePrefix" value="pre_">
    </div>
  </div>
