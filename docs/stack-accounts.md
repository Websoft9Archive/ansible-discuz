...
These accounts are required for Discuz image installation and configuration

## Discuz

Administrator account is set by yourselft at the time of Discuz installation wizard
